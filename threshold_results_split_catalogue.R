...
# V-based thresholds ------------------------------------------------------
geo_thresh_fit_before <- readRDS("threshold_results/geo_thresh_fit_before.rds")
...
geo_thresh_fit_after <- readRDS("threshold_results/geo_thresh_fit_after.rds")
...
geo_thresh_fit_belowV <- readRDS("threshold_results/geo_thresh_fit_belowV.rds")
...
geo_thresh_fit_aboveV <- readRDS("threshold_results/geo_thresh_fit_aboveV.rds")
...
get_par_ests_geo(mags_before, geo_thresh_fit_before, third_nearest_dist_before)
...
get_par_ests_geo(mags_after, geo_thresh_fit_after, third_nearest_dist_after)
...
get_par_ests_geo(mags_belowV, geo_thresh_fit_belowV, third_nearest_dist_belowV)
...
get_par_ests_geo(mags_aboveV, geo_thresh_fit_aboveV, third_nearest_dist_aboveV)
...
points(geo_thresh_fit_3d_before$thresh[1] + geo_thresh_fit_3d_before$thresh[2]*third_nearest_dist_3d_before, col="blue", pch=19)
points(geo_thresh_fit_3d_after$thresh[1] + geo_thresh_fit_3d_after$thresh[2]*third_nearest_dist_3d_after, col="green", pch=19)
points(geo_thresh_fit_3d_belowV$thresh[1] + geo_thresh_fit_3d_belowV$thresh[2]*third_nearest_dist_3d_belowV, col="purple", pch=19)
points(geo_thresh_fit_3d_aboveV$thresh[1] + geo_thresh_fit_3d_aboveV$thresh[2]*third_nearest_dist_3d_aboveV, col="orange", pch=19)
legend("bottomright", legend=c("All", "Before", "After", "Below V=5", "Above V=5"), col=c("red", "blue", "green", "purple", "orange"), pch=19)
...
points(log_geo_thresh_fit_3d_before$thresh[1] + log_geo_thresh_fit_3d_before$thresh[2]*log_third_nearest_dist_3d_before, col="blue", pch=19)
points(log_geo_thresh_fit_3d_after$thresh[1] + log_geo_thresh_fit_3d_after$thresh[2]*log_third_nearest_dist_3d_after, col="green", pch=19)
points(log_geo_thresh_fit_3d_belowV$thresh[1] + log_geo_thresh_fit_3d_belowV$thresh[2]*log_third_nearest_dist_3d_belowV, col="purple", pch=19)
points(log_geo_thresh_fit_3d_aboveV$thresh[1] + log_geo_thresh_fit_3d_aboveV$thresh[2]*log_third_nearest_dist_3d_aboveV, col="orange", pch=19)
legend("bottomright", legend=c("All", "Before", "After", "Below V=5", "Above V=5"), col=c("red", "blue", "green", "purple", "orange"), pch=19)
...
points(sqrt_geo_thresh_fit_3d_before$thresh[1] + sqrt_geo_thresh_fit_3d_before$thresh[2]*sqrt_third_nearest_dist_3d_before, col="blue", pch=19)
points(sqrt_geo_thresh_fit_3d_after$thresh[1] + sqrt_geo_thresh_fit_3d_after$thresh[2]*sqrt_third_nearest_dist_3d_after, col="green", pch=19)
points(sqrt_geo_thresh_fit_3d_belowV$thresh[1] + sqrt_geo_thresh_fit_3d_belowV$thresh[2]*sqrt_third_nearest_dist_3d_belowV, col="purple", pch=19)
points(sqrt_geo_thresh_fit_3d_aboveV$thresh[1] + sqrt_geo_thresh_fit_3d_aboveV$thresh[2]*sqrt_third_nearest_dist_3d_aboveV, col="orange", pch=19)
legend("bottomright", legend=c("All", "Before", "After", "Below V=5", "Above V=5"), col=c("red", "blue", "green", "purple", "orange"), pch=19)
