...
#Below and above V=V_cutoff
V_cutoff <- V_cutoff
gron_eq_cat_belowV <- gron_eq_cat[gron_eq_cat$V_3d <= V_cutoff,]
mags_belowV <- gron_eq_cat_belowV$Magnitude
third_nearest_dist_belowV_3d <- gron_eq_cat_belowV$V_3d
log_third_nearest_dist_belowV_3d <- log(third_nearest_dist_belowV_3d)
sqrt_third_nearest_dist_belowV_3d <- sqrt(third_nearest_dist_belowV_3d)
...
third_nearest_dist_aboveV_3d <- gron_eq_cat_aboveV$V_3d
log_third_nearest_dist_aboveV_3d <- log(third_nearest_dist_aboveV_3d)
sqrt_third_nearest_dist_aboveV_3d <- sqrt(third_nearest_dist_aboveV_3d)
...
eqd_belowV <- eqd_threshold[gron_eq_cat$V_3d <= V_cutoff]
eqd_aboveV <- eqd_threshold[gron_eq_cat$V_3d > V_cutoff]
...
conserv_belowV <- conservative_threshold[gron_eq_cat$V_3d <= V_cutoff]
conserv_aboveV <- conservative_threshold[gron_eq_cat$V_3d > V_cutoff]
...
pc_belowV <- piecewise_const_thresh[gron_eq_cat$V_3d <= V_cutoff]
pc_aboveV <- piecewise_const_thresh[gron_eq_cat$V_3d > V_cutoff]


# Fitted stepped threshold ------------------------------------------------
pc_thresh_fit <- readRDS("threshold_results/pc_thresh_fit.rds")
pc_threshold <- c(rep(pc_thresh_fit$thresh_par[1], u_h_length), rep(pc_thresh_fit$thresh_par[2], length(mags) - u_h_length))

pc_thresh_fitted_before <- pc_threshold[1:u_h_length]
pc_thresh_fitted_after <- pc_threshold[(u_h_length+1):length(mags)]

pc_fitted_belowV <- pc_threshold[gron_eq_cat$V_3d <= V_cutoff]
pc_fitted_aboveV <- pc_threshold[gron_eq_cat$V_3d > V_cutoff]
...
geo_thresh_fit_belowV_2d <- readRDS("threshold_results/geo_thresh_fit_belowV_2d.rds")
geo_thresh_fit_belowV_3d <- readRDS("threshold_results/geo_thresh_fit_belowV_3d.rds")
log_geo_thresh_fit_belowV_3d <- readRDS("threshold_results/log_geo_thresh_fit_belowV_3d.rds")
sqrt_geo_thresh_fit_belowV_3d <- readRDS("threshold_results/sqrt_geo_thresh_fit_belowV_3d.rds")

geo_thresh_fit_aboveV_2d <- readRDS("threshold_results/geo_thresh_fit_aboveV_2d.rds")
geo_thresh_fit_aboveV_3d <- readRDS("threshold_results/geo_thresh_fit_aboveV_3d.rds")
log_geo_thresh_fit_aboveV_3d <- readRDS("threshold_results/log_geo_thresh_fit_aboveV_3d.rds")
sqrt_geo_thresh_fit_aboveV_3d <- readRDS("threshold_results/sqrt_geo_thresh_fit_aboveV_3d.rds")
...
get_par_ests_geo(mags_belowV_2d, geo_thresh_fit_belowV_2d, third_nearest_dist_belowV_2d)

get_par_ests_geo(mags_belowV, geo_thresh_fit_belowV_3d, third_nearest_dist_belowV_3d)
get_par_ests_geo(mags_belowV, log_geo_thresh_fit_belowV_3d, log_third_nearest_dist_belowV_3d)
get_par_ests_geo(mags_belowV, sqrt_geo_thresh_fit_belowV_3d, sqrt_third_nearest_dist_belowV_3d)
...
get_par_ests_geo(mags_aboveV_2d, geo_thresh_fit_aboveV_2d, third_nearest_dist_aboveV_2d)

get_par_ests_geo(mags_aboveV, geo_thresh_fit_aboveV_3d, third_nearest_dist_aboveV_3d)
get_par_ests_geo(mags_aboveV, log_geo_thresh_fit_aboveV_3d, log_third_nearest_dist_aboveV_3d)
get_par_ests_geo(mags_aboveV, sqrt_geo_thresh_fit_aboveV_3d, sqrt_third_nearest_dist_aboveV_3d)
